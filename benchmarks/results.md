...
| fp32_ref -O2 softfp | TFLM reference (FPU) | FP32 | 140,246 | 584 µs | 1,712 B | 72,236 B |
...
Finding: **FP32 w/ FPU (140k cyc) is 2.3x FASTER than naive INT8 (326k)** — quantization only pays off
with CMSIS-NN kernels (84k). Naive INT8 requantization in portable C is expensive.
